...
<head>
<meta charset="utf-8">
<title>Providexpert - Expert's Answers</title>

<meta content="width=device-width, initial-scale=1.0" name="viewport">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">

<meta content="We provide answers from experts" name="description">
<meta content="great team" name="author">
...
<link href="{{ asset('assets/frontend/onepage/css/themes/orange.css') }}" rel="stylesheet" id="style-color">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-2 col-sm-2">
        <a class="scroll site-logo" href="#promo-block"><img src="{{ asset('assets/frontend/onepage/img/logo/providexpert-logo.png') }}" alt="Providexpert"></a>
      </div>
      <!-- Logo END -->
      ...
      <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-1">
        ...
        <div class="tp-caption large_text customin customout start"
          ...
          <div class="promo-like-text">
            ...
            <p>Seeking Professional Answers? Get the answers from experts.<br /><a href="/login">Start Here</a></p>
          </div>
        </div>
          <div class="tp-caption large_bold_white fade"
            ...
            style="z-index: 6">Ask <span>Advice</span> From Experts
          </div>
      </li>
      <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-2">
        <img src="{{ asset('assets/frontend/onepage/img/silder/slide2.jpg') }}" alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
        <div class="tp-caption large_text customin customout start"
          data-x="center"
          data-hoffset="0"
          data-y="center"
          ...
          <div class="tp-caption large_bold_white fade"
            ...
            data-endeasing="Power1.easeIn"
            data-captionhidden="off"
            style="z-index: 6">Professional Experts
          </div>
      </li>
      </ul>
    </div>
...
<div class="about-block content content-center" id="about">
  <div class="container">
    <h2><strong>What Is This All</strong> About ?</h2>
    <h4>Most of the time, people are not satisfied with the answers that they get. Here, our experts from different fields are registered here to give answers that people NEED. People will no longer get misleading information as every single answer is CRITICAL.</h4>
...
<div class="choose-us-block content text-center margin-bottom-40" id="benefits">
  <div class="container">
    ...
    <h4>Because we carefully choose our experts who have expertise in their fields. So, you will get your answers from those who really have the skills and experiences.</h4>
