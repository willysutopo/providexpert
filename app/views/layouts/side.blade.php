<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
	...
	<li class="{{ ( ( $menu_active == 'topup' ) ? 'active open' : '' ) }}">
		<a href="/topup">
		<i class="fa fa-dollar"></i>
		<span class="title">Top Up Credits</span>
		</a>
	</li>
	...
	<li class="{{ ( ( $menu_active == 'question' ) ? 'active open' : '' ) }}">
		<a href="javascript:">
		...
		<ul class="sub-menu">
			<li class="{{ ( ( $sub_menu_active == 'ask' ) ? 'active' : '' ) }}">
				<a href="/ask"><i class="icon-list"></i> Ask Question</a>
			</li>
			<li class="{{ ( ( $sub_menu_active == 'list' ) ? 'active' : '' ) }}">
				<a href="/questions"><i class="icon-list"></i> Question List</a>
			</li>			
		</ul>
	</li>
</ul>
