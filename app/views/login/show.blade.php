...
<head>
<meta charset="utf-8"/>
<title>Providexpert - Login</title>
...
<div class="logo">
	<a href="/">
	<img src="{{{ asset('assets/admin/layout/img/providexpert-logo.png') }}}" alt="" border="0" />
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<!-- BEGIN LOGIN FORM -->
	@if (Session::get('error') || (Session::get('notice') && Session::get('from')==""))
	{{Form::open(array('url' => 'login/login_process','id' =>'formLogin','class'=>"login-form",'style'=>'display:none'))}}
	@else
	{{Form::open(array('url' => 'login/login_process','id' =>'formLogin','class'=>"login-form"))}}
	@endif
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				{{Form::text("email",Session::get('email'),array("data-required"=>"1","class"=>"form-control placeholder-no-fix","autocomplete"=>"off","placeholder"=>"Email"))}}	
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-actions ">
			<div class="display-hide">
				<label class="checkbox display-hide">
				<input type="checkbox" name="remember" value="1"/> Remember me </label>
			</div>
			<a href="javascript:;" id="register-btn">Register New Account</a>
		...
		<div class="copyright">
			{{ date("Y") }} &copy; Providexpert | All Rights Reserved
		</div>
		<div class="create-account display-hide">
			<p>
				 Don't have an account yet ?&nbsp; <a href="javascript:;" id="register-btn-test">
				Create an account </a>
			</p>
		</div>
	{{Form::close()}}
	...
	@if (Session::get('error') || (Session::get('notice') && Session::get('from')==""))
	{{Form::open(array('url' => 'login/forgot_password','id' =>'formForgotPassword','class'=>'forget-form','style'=>'display:block'))}}
	@else
	{{Form::open(array('url' => 'login/forgot_password','id' =>'formForgotPassword','class'=>'forget-form'))}}
	@endif
	    ...
	    @if (Session::get('notice') && Session::get('error')=="")
	...
	{{ Form::open(array('route' => 'login.register', 'class'=>'form-horizontal register-form', 'role'=>'form')) }}	
		<h3>Sign Up</h3>
		<p>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Telephone" name="phone"/>
			</div>
		</div>
		<p>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<div class="pt5 pl10 pb5" style="color:#666666">
