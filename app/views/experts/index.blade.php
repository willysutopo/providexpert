...
<head>
<meta charset="utf-8"/>
<title>Choose Expert Category | Providexpert</title>
...
<body class="ask_choose_category page-header-fixed page-quick-sidebar-over-content ">
<!-- BEGIN HEADER -->
@include('layouts.top')
<!-- END HEADER -->
<div class="clearfix">
...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			<!-- BEGIN SIDEBAR MENU -->
			@include('layouts.side', array('menu_active' => 'expert', 'sub_menu_active' => ''))
			<!-- END SIDEBAR MENU -->
		</div>
	</div>
	<!-- END SIDEBAR -->
