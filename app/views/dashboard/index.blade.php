...
<head>
<meta charset="utf-8"/>
<title>Dashboard | Providexpert</title>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<div class="details">
							<div class="number">
								{{ $user->credits }} Credit{{ ( ( $user->credits < 2 ) ? "" : "s" ) }}
								<div class="mt10"></div>
								<button class="btn default date-set" type="button" onClick="location.href='/topup'"><i class="fa fa-plus"></i> Top Up Credits</button>
								<div class="mt20"></div>
								{{ $user->question_count }} Question{{ ( ( $user->question_count < 2 ) ? "" : "s" ) }} Asked
								<div class="mt5"></div>
								{{ $user->answer_count }} Answered
								<div class="mt10"></div>
							</div>
						</div>
					</div>
