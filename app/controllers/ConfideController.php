 ...
 */
class ConfideController extends Controller
{
    ...
    public function doForgotPassword()
    {
        if (Confide::forgotPassword(Input::get('email'))) {
            ...
            //return Redirect::action('AdminController@doForgotPassword')
    ...
    public function doResetPassword()
    {
        ...
        if ($repo->resetPassword($input)) {
            ...
            return Redirect::action('ConfideController@resetPassword', array('token'=>$input['token']))
                ->withInput()
                ->with('error', $error_msg);
        }
    }
