...
/*
$upload_dir = '/assets/uploads/'; // path from base_url to base of upload folder (with start and final /)
...
$upload_dir = '/assets/global/plugins/jquery-file-upload/server/php/files/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../global/plugins/jquery-file-upload/server/php/files/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../global/plugins/jquery-file-upload/server/php/files/thumbnail/'; // relative path from filemanager folder to thumbs folder (with final /)
$full_path = $base_url . $upload_dir;
...
$ext_file 	= array('doc', 'docx', 'xls', 'xlsx', 'pdf', 'txt', 'csv', 'ppt', 'pptx'); //array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','xhtml','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai'); //Files
$ext_video 	= array('mov', 'mpeg', 'mp4', 'avi', 'mpg', 'wma', 'flv', 'webm'); //array('mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg','wma',"flv","webm"); //Video 
$ext_music 	= array('mp3', 'm4a', 'wav'); //array('mp3', 'm4a', 'ac3', 'aiff', 'mid','ogg','wav'); //Audio
$ext_misc 	= array('zip', 'rar', 'gz', 'tar'); //array('zip', 'rar','gz','tar','iso','dmg'); //Archives

$ext = array_merge($ext_img, $ext_file, $ext_video, $ext_music, $ext_misc);
//array_merge($ext_img, $ext_file, $ext_misc, $ext_video,$ext_music); //allowed extensions
...
$hidden_folders = array('thumbnail');
...
$fixed_path_from_filemanager            = array('../global/plugins/jquery-file-upload/server/php/files/'); //fixed path of the image folder from the current position on upload folder
$fixed_image_creation_name_to_prepend   = array('','test_'); //name to prepend on filename
$fixed_image_creation_to_append         = array('_test',''); //name to appendon filename
$fixed_image_creation_width             = array(80); //width of image (you can leave empty if you set height)
